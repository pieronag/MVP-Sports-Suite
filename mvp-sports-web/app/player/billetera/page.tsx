...
import { ChevronLeft, ShieldCheck, Clock, CreditCard, Landmark, MapPin, Receipt, ArrowRight } from "lucide-react";
      ...
      <div className="px-5 mt-3 space-y-4 pb-8">
        ...
        <div className="flex gap-3">
          <GlowCard isDark={isDark} className="flex-1">
            <div className="p-4">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-7 h-7 rounded-[14px] flex items-center justify-center bg-emerald-500/10">
          ...
          <GlowCard isDark={isDark} className="flex-1">
            <div className="p-4">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-7 h-7 rounded-[14px] flex items-center justify-center bg-blue-500/10">
