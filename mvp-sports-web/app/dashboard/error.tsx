...
export default function DashboardError({
  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center text-center p-8 min-h-[60vh]">
      <div className="w-16 h-16 rounded-[14px] bg-red-50 dark:bg-red-500/10 flex items-center justify-center mb-6">
      ...
      <button
        onClick={reset}
        className="flex items-center gap-2 px-6 py-3 bg-emerald-500 text-white font-black rounded-[14px] uppercase text-xs tracking-widest hover:bg-emerald-400 transition-all shadow-lg shadow-emerald-500/20"
      >
