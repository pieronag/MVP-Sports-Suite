                ...
                options={{
                    tabBarIcon: ({ focused, color }) => (
                        <View style={{
                            ...
                            height: focused ? 58 : 44,
                            borderRadius: 22,
                            backgroundColor: focused ? THEME.mapa : 'transparent',
                            marginTop: focused ? -25 : 0,
                            shadowColor: THEME.mapa,
                            shadowOpacity: focused ? 0.4 : 0,
                            shadowRadius: 12,
                            elevation: focused ? 10 : 0,
                            borderWidth: focused ? 2 : 0,
                            ...
                            <MapPin color={focused ? '#FFFFFF' : color} size={focused ? 24 : 22} strokeWidth={focused ? 2.5 : 2} />
                        </View>
                    ),
                }}
                listeners={{
                ...
                options={{
                    tabBarIcon: ({ focused, color }) => (
                        <View style={{
                            ...
                            height: focused ? 58 : 44,
                            borderRadius: 22,
                            backgroundColor: focused ? THEME.reservas : 'transparent',
                            marginTop: focused ? -25 : 0,
                            shadowColor: THEME.reservas,
                            shadowOpacity: focused ? 0.4 : 0,
                            shadowRadius: 12,
                            elevation: focused ? 10 : 0,
                            borderWidth: focused ? 2 : 0,
                            ...
                            <CalendarRange color={focused ? '#FFFFFF' : color} size={focused ? 24 : 22} strokeWidth={focused ? 2.5 : 2} />
                        </View>
                    ),
                }}
                listeners={{
                ...
                options={{
                    tabBarIcon: ({ focused, color }) => (
                        <View style={{
                            ...
                            height: focused ? 58 : 44,
                            borderRadius: 22,
                            backgroundColor: focused ? THEME.perfil : 'transparent',
                            marginTop: focused ? -25 : 0,
                            shadowColor: THEME.perfil,
                            shadowOpacity: focused ? 0.4 : 0,
                            shadowRadius: 12,
                            elevation: focused ? 10 : 0,
                            borderWidth: focused ? 2 : 0,
